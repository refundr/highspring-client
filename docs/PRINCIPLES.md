...
These principles apply across Highspring (API, database, and clients). Prefer them when writing code, tests, and docs.
...
See also the API copy in `highspring-rest/docs/PRINCIPLES.md` when working across both repos.
