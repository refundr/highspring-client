...
import {deleteAdminError, deleteAllAdminErrors, type ErrorLog, fetchAdminErrors, fetchAdminPurchases, fetchAdminTotals,} from "~/utils/api.server";
import {readSessionUser} from "~/utils/session.server";
import {btnCompact, btnGhost, btnSecondary, code, heading, hero, muted, panel, shell, table,} from "~/utils/ui";
                        ...
                        {errors.map((error) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <pre
                                        className="max-h-[28rem] max-w-full overflow-auto whitespace-pre-wrap break-words rounded-xl border border-line bg-ink/5 p-3 text-[0.78rem] leading-[1.35] text-ink">
                    {error.stackTrace || ""}
                  </pre>
                                </li>
                            );
